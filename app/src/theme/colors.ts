/**
 * BNA UI theme colors — the stock palette exactly as the library ships it.
 *
 * Every BNA component resolves its colours through `useColor`, which indexes
 * `Colors[scheme][key]` here. This file is intentionally untouched: light and
 * dark follow the library defaults so the app looks like BNA UI out of the box.
 */
const lightColors = {
  // Base colors
  background: '#FFFFFF',
